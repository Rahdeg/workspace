...
export const MessageList = ({ canLoadMore, channelCreationTime, channelName, memberImage, memberName, variant = "channel", loadMore, isLoadingMore, data }: MessageListProps) => {
                    ...
                    <div key={datekey}>
                        ...
                        </div>
                        {
                            messages.map((message, index) => {
                                ...
                                const isCompact = preMessage && preMessage.user?._id === message?.user._id && differenceInMinutes(
