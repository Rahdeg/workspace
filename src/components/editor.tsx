...
const Editor = ({ variant = "create", onCancel, onSubmit, placeholder = "Write something...", defaultValues = [], disabled = false, innerRef }: EditorProps) => {
                ...
                <div className=" flex px-2 pb-2 z-[5]">
...

                    {
                        variant === "create" && (
                            ...
                            }} disabled={disabled || isEmpty} size="iconSm" className={cn("ml-auto", isEmpty ? " bg-white hover:bg-white text-muted-foreground" : "  bg-[#007a5a] hover:bg-[#007a5a]/80 text-white")}>
...

                    {
                        variant === "update" && (
                            ...
                            <div className=" ml-auto flex items-center gap-x-2">
                                <Button onClick={onCancel} disabled={disabled} variant="outline" size="sm" >
                                    Cancel
                                </Button>
                                <Button onClick={() => {
                                    onSubmit({
                                ...
                                }} disabled={disabled || isEmpty} size="sm" className=" ml-auto bg-[#007a5a] hover:bg-[#007a5a]/80 text-white" >
                                    send
                                </Button>
                            </div>
